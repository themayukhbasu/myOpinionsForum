	...
	if($flag == 0) {
		...
		if($id == 0) {
			...
			if($val == 0){
				...
				$link = 'localhost/forum/forgetPassword.php?token='.$token;
				$subject = 'Reset Password Link';
				$emailBody = 'Please click on the link below to reset your password <br/> <br/> <a href="'.$link.'">'.$link.'</a>';
				$altBody = 'Please copy paste this link to reset your password : '.$link;
				$resultDes = 'A link has been sent to your email address. Please click on the link to reset your password.';
